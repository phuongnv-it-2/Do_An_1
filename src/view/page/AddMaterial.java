...
public class AddMaterial extends JPanel {
    ...
    private MyTextField txtName, txtDonVi, txtSoLuong, txtGiaNhap, txtNhaCungCap, txtAnh, txtFind;
    ...
    public AddMaterial() {
        ...
        jTable1.setModel(new DefaultTableModel(
                new Object[][]{},
                new String[]{"STT", "ID", "Name", "Type", "Unit", "Quantity", "Expiration Date", "Import Date", "Import Price", "Supplier", "Image"}
        ));
        ...
        JbtThem.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                ...
                txtAnh.setEditable(true);
                txtName.setText("");
                txtLoai.setSelectedIndex(-1); // No selection
                txtDonVi.setText("");
                txtSoLuong.setText("");
        ...
        JbtLuu.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                try {
                    ...
                    if (ten.isEmpty() || loai == null || donVi.isEmpty() || soLuongText.isEmpty()
                    ...
                    JOptionPane.showMessageDialog(null, "Material saved successfully!", "Info", JOptionPane.INFORMATION_MESSAGE);
                } catch (NumberFormatException e) {
                    JOptionPane.showMessageDialog(null, "Quantity and import price must be valid numbers!", "Error", JOptionPane.ERROR_MESSAGE);
                } catch (SQLException ex) {
