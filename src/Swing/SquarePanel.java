...
public class SquarePanel extends JPanel {
    ...
    private final Color baseColor1 = new Color(255, 102, 102);
    private final Color baseColor2 = new Color(102, 204, 255);
    private final Color baseColor3 = new Color(153, 255, 153);
    ...
    timer = new Timer(60, new ActionListener() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (progress >= 1f) {
                ...
                // Dịch vòng màu (xoay vòng: 1→2, 2→3, 3→1)
                fromColor1 = toColor1;
                toColor1 = toColor2;
...
private Color getNextColor(Color current) {
    if (current.equals(baseColor1)) return baseColor2;
    if (current.equals(baseColor2)) return baseColor3;
    return baseColor1;
}
